<?php
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        if (isset($_GET['id'])) {
            ...
            mysqli_close($dbc);
            die("Nije pronađena kategorija.");
        }

        if ($kategorija != "Sport" and $kategorija != "Kultura") {
            mysqli_close($dbc);
            die("Ne postojeća kategorija.");
        }
    }
?>
    ...
    <main>
        <div class="news-categories">
            <section class="category">
                ...
                <div class="articles">
                <?php
                    $sql = "SELECT id, datum, naslov, sazetak, slika FROM clanci WHERE kategorija = '$kategorija' AND arhiva = 0 ORDER BY datum DESC";
