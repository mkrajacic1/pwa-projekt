<?php
    if ($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        $sql = "SELECT id, datum, naslov, sazetak, tekst, slika, kategorija FROM clanci WHERE id = ?";
        ...
        mysqli_stmt_bind_result($stmt, $id, $datum, $naslov, $sazetak, $tekst, $slika, $kategorija);
